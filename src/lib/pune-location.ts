...
const CITY_ALIASES: Record<SupportedCityName, string[]> = {
  ...
  Kolhapur: ["kolhapur", "klp"],
  Nashik: ["nashik", "nasik", "nsk"],
  Bangalore: ["bangalore", "bengaluru", "blr", "bangaluru"],
  Chennai: ["chennai", "madras", "maa"],
  CherryHill: ["cherryhill", "cherry hill"],
  Delhi: ["delhi", "new delhi", "ncr", "noida", "gurgaon", "del"],
  Hyderabad: ["hyderabad", "hyd", "hyderbad", "secunderabad"],
  Kolkata: ["kolkata", "calcutta", "ccu"],
  Ahmedabad: ["ahmedabad", "amd", "ahmedbad"],
  Jaipur: ["jaipur", "jai"],
  Lucknow: ["lucknow", "lko"],
  ...
  Surat: ["surat", "stv"],
  Patna: ["patna", "pat"],
  Bhubaneswar: ["bhubaneswar", "bhubaneshwar", "bubhneshwar", "bbsr", "bbi", "odisha", "orissa"],
