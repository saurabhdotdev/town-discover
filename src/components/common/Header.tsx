...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <motion.header
      ...
      className={cn(
        "sticky top-0 z-30 border-b border-[var(--border)] bg-[var(--nav)] backdrop-blur-xl md:top-16",
        className
      )}
    >
      <div className="mx-auto flex max-w-screen-xl flex-col gap-3 px-3 py-3 pr-16 sm:px-4 md:flex-row md:items-end md:justify-between md:px-6 md:py-5">
        <div className="min-w-0">
          ...
          <h1 className="truncate text-xl font-black tracking-tight text-[var(--foreground)] sm:text-2xl md:text-3xl">{title}</h1>
